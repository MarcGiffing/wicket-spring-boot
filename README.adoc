...
* 5.0.x - http://wicket.apache.org/[Wicket 10.x] with Spring Boot 4.0.x - Branch master
* 4.1.x - http://wicket.apache.org/[Wicket 10.x] with Spring Boot 3.5.x - No branch available
* 4.0.x - http://wicket.apache.org/[Wicket 10.x] with Spring Boot 3.2.x - Branch wicket-10

...
* http://wicket.apache.org/[Wicket 8.x] 2.x.x
* http://wicket.apache.org/[Wicket 7.x] 1.x.x
...
* Optionally you can extend from SpringBootServletInitializer to set configuration which only apply when deployed as a war in a Servlet Container.

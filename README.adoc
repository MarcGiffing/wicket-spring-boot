...
. Create a application class which is marked with @SpringBootApplication as usal 
...
TODO explain how you can extend the init configuration and how to provide you ohn WicketApplication class/bean

...
* 2.1.x - http://wicket.apache.org/[Wicket 8.x] with Spring Boot 2 - Branch #85_Wicket_8_Support
* 2.0.x - http://wicket.apache.org/[Wicket 8.x] with Spring Boot 1 - Branch #85_Wicket_8_Support
* 1.x.x - http://wicket.apache.org/[Wicket 7.x] with Spring Boot 1 - Branch master

...
* 2.1.x - http://wicket.apache.org/[Wicket 8.x] with Spring Boot 2
* 2.0.x - http://wicket.apache.org/[Wicket 8.x] with Spring Boot 1 
* 1.x.x - http://wicket.apache.org/[Wicket 7.x] with Spring Boot 1
